      ...
      body: subjects.when(
        ...
        data: (items) => ListView(
          ...
          latestSession.when(
            ...
            data: (session) {
              if (session == null || _resumePromptDismissed) return const SizedBox.shrink();
                    ...
                    children: [
                      ...
                      Consumer(
                        builder: (context, ref, _) {
                          ...
                          return unit.when(
                            loading: () => const Text('Loading learning unit...'),
                            error: (_, __) => const Text('Previous learning unit'),
                            data: (value) => Text(
